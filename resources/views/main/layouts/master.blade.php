            ...
            <div class="top-nav-left d-flex justify-content-between align-items-center">
                ...
                @elseif (auth('brokers')->check())
                    ...
                    <div class="dropdown user-panel-menu">
                        ...
                        <ul class="dropdown-menu">
                            <li>
                                <a class="dropdown-item fw-bold py-3" href="{{ route('broker.edit','broker') }}">
                                    <i class="fa fa-user-circle fs-3 align-middle gray-400 pe-1"></i>
                                    {{auth('brokers')->user()->f_name.' '.auth('brokers')->user()->l_name}}
                                    <i class="fa fa-angle-left ps-2 gray-500"></i>
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item  py-2 fw-bold" href="broker/panel">
                                    <span class="pe-1">
                                        <!--begin::Svg Icon-->
                                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-vcard-fill" viewBox="0 0 16 16">
                                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm9 1.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.5.5M9 8a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4A.5.5 0 0 0 9 8m1 2.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1h-3a.5.5 0 0 0-.5.5m-1 2C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1 1 0 0 0 2 13h6.96q.04-.245.04-.5M7 6a2 2 0 1 0-4 0 2 2 0 0 0 4 0"/>
...
{{--                            </li>--}}
                            <li>
                                <a class="dropdown-item  py-3 fw-bold" href="{{route('logout', 'brokers')}}">
                                    <span class="pe-1">
                                        <!--begin::Svg Icon-->
                                        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                            width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                ...
                <div class="main-mobile-navbar-left">
                    <div class="dropdown user-panel-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            @elseif (auth('brokers')->check())
                                <li>
                                    <a class="dropdown-item fw-bold" href="{{ route('broker.edit','broker') }}">
                                        <i class="fa fa-user-circle fs-3 align-middle gray-400 pe-1"></i>
                                        {{auth('brokers')->user()->f_name.' '.auth('brokers')->user()->l_name}}
                                        <i class="fa fa-angle-left ps-2 gray-500"></i>
                                    </a>
                                ...
                                <li>
                                    <a class="dropdown-item fw-bold" href="broker/panel">
                                        <span class="pe-1">
                                            <!--begin::Svg Icon-->
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-person-vcard-fill" viewBox="0 0 16 16">
                                                <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm9 1.5a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4a.5.5 0 0 0-.5.5M9 8a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 0-1h-4A.5.5 0 0 0 9 8m1 2.5a.5.5 0 0 0 .5.5h3a.5.5 0 0 0 0-1h-3a.5.5 0 0 0-.5.5m-1 2C9 10.567 7.21 9 5 9c-2.086 0-3.8 1.398-3.984 3.181A1 1 0 0 0 2 13h6.96q.04-.245.04-.5M7 6a2 2 0 1 0-4 0 2 2 0 0 0 4 0"/>
...
{{--                                </li>--}}
                                <li>
                                    <a class="dropdown-item fw-bold" href="{{ route('logout', 'brokers')}}">
                                        <span class="pe-1">
                                            <!--begin::Svg Icon-->
                                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                                width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
