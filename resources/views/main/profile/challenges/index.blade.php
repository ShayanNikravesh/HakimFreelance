                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <form action="" method="POST" enctype="multipart/form-data">
                                                        @csrf
                                                        <div class="col-md-12">
                                                            <input class="form-control border-radius-xl mb-2"
                                                                   placeholder="عنوان چالش خود را وارد کنید."
                                                                   name="title">
                                                            <textarea class="form-control border-radius-xl"
                                                                      placeholder="توضیح چالش خود را وارد کنید."
                                                                      name="desc" rows="4"></textarea>
                                                        </div>
                                                        <div class="col-md-12">
                                                            <label for="photo" class="form-label fw-bold"> فایل
                                                                ها</label>
                                                                ...
                                                                <div class="col-md-12">
                                                                    @foreach ($challenge->challengeFile as $key=>$file )
                                                                        <a class="btn btn-primary mb-2"
                                                                           href="{{asset($file->file)}}">فایل {{$key+1}}</a>
                                                                    @endforeach
                                                                </div>
                                                            @endif
                                                            <div
