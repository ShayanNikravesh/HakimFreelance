                                        ...
                                        <div class="user-panel-comments-content p-4">
                                            ...
                                            <div
                                                ...
                                                <div>
                                                    ...
                                                    <div
                                                        class="user-panel-comment-item-header d-flex justify-content-between align-items-center border-bottom-gray-300 pb-2">
                                                        <p class="fw-bold">
                                                        ...
                                                        <div class="d-flex justify-content-between align-items-center">
                                                            @if ($comment->status == 'active')
                                                                <span
                                                                    class="badge d-block custom-box-shadow-s-1 bg-green">تایید شده</span>
                                                            @else
                                                                <span
