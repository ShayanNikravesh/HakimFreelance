                    ...
                    <div class="col-sm-12 col-md-12 col-lg-8 col-xl-9">
                        ...
                        <div class="user-panel-content">
                            ...
                            <div class="user-panel-profile mt-3 border border-radius-xl">
                                ...
                                <div
                                    class="user-panel-profile-header d-flex justify-content-between align-items-center p-3 border-bottom-gray-300 mb-3">
                                ...
                                <div class="user-panel-profile-content p-3">
                                    ...
                                    <form class="row g-3" action="{{route('Users.update','User')}}" method="POST">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <input type="text" class="form-control border-radius-xl" name="f_name"
                                                   id="name1" placeholder="نام خود را وارد کنید ..."
                                                   value="{{$user->f_name}}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="l_name" class="form-label fw-bold">نام خانوادگی:</label>
                                            <input type="text" class="form-control border-radius-xl" name="l_name"
                                                   id="name1" placeholder="نام خود را وارد کنید ..."
                                                   value="{{$user->l_name}}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="phoneNumber1" class="form-label fw-bold">شماره موبایل:</label>
                                            <input type="tel" class="form-control border-radius-xl" name="mobile"
                                                   id="phoneNumber1" placeholder="09xxxxxxxxx"
                                                   value="{{$user->mobile}}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="phoneNumber1" class="form-label fw-bold">کد ملی:</label>
                                            <input type="tel" class="form-control border-radius-xl" name="national_code"
                                                   id="phoneNumber1" placeholder="09xxxxxxxxx"
                                                   value="{{$user->national_code}}">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="password" class="form-label fw-bold">رمز عبور جدید</label>
                                            <input type="password" class="form-control border-radius-xl" name="password"
                                                   id="password" placeholder="رمز جدید را وارد کنید">
                                        </div>
                                        <div class="col-md-6">
                                            <label for="repassword" class="form-label fw-bold">تکرار رمز عبور</label>
                                            <input type="password" class="form-control border-radius-xl"
                                                   name="password_confirmation" id="repassword"
                                                   placeholder="رمز جدید را دوباره وارد کنید">
                                        </div>
                                        <div class="col-12">
                                            <button type="submit" class="btn custom-btn-primary border-radius-xl">ثبت
                                            </button>
                                        </div>
                                    </form>
                                </div>
