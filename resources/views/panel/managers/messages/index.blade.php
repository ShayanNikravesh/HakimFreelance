						...
						@if ($messages)
							@foreach ($messages as $message)
								...
								<tr>
									...
									<td>
										<div class="d-flex">
                                            <a href="{{route('message_val.update',[$message->id,'status'=>'active'])}}" class="btn btn-success btn-sm" data-toggle="tooltip" data-placement="top" title="تایید ارسال">
											...
											<form action="" method="POST">
												@csrf
												@method('DELETE')
                                                    <button class="btn-sm btn-danger btn mx-1" data-toggle="tooltip" data-placement="top" title="حذف پیام">
