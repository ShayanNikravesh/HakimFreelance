            ...
            <div class="main-mobile-navbar py-2">
                ...
                <div class="container d-flex justify-content-between align-items-center">
                    ...
                    <div class="main-mobile-navbar-left">
                        ...
                        <a href="{{route('Login')}}" class="btn text-dark-blue border-radius-xl">
                            <!--begin::Svg Icon -->
                        ...
                        <a href="" data-bs-toggle="modal" data-bs-target="#insertNewBrokerModal" class="btn text-dark-blue border-radius-xl" title="">
                            <!--begin::Svg Icon -->
        ...
        <div class="top-navbar navbar-expand-lg navbar-light py-2">
            ...
            <div class="container d-flex justify-content-between align-items-center">
                ...
                <div class="top-nav-left d-flex justify-content-between align-items-center">
                    <!--Login and Register:start-->
                    <a href="{{route('Login')}}" class="btn me-3 border-gray-300 border-radius-xl">
                        <!--begin::Svg Icon -->
                    ...
                    <!-- brokers register start-->
                    <a href="" data-bs-toggle="modal" data-bs-target="#insertNewBrokerModal" class="btn me-3 border-gray-300 border-radius-xl" title="">
                        <!--begin::Svg Icon -->
                        <svg class="rotate-3d me-2" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                            height="24px" viewBox="0 0 24 24" version="1.1">
