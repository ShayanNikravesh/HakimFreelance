                    ...
                    <div class="user-panel-content">
                        ...
                        <div class="user-panel-comments mt-3 border border-radius-xl">
                            ...
                            <div class="user-panel-comments-header d-flex justify-content-between align-items-center p-3 border-bottom-gray-300">
                                ...
                                <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#IdeaModal">ثبت ایده جدید</a>
                                <!-- Modal -->
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                <form action="{{route('ideas.store')}}" method="POST" enctype="multipart/form-data">
                                                    @csrf
                                                    <textarea class="form-control border-radius-xl" name="idea" rows="4"></textarea>
                                                    <div class="col-md-6">
                                                        <label for="photo" class="form-label fw-bold">فایل</label>
                                                        <input name="file" type="file" class="form-control border-radius-xl" id="photo">
                                                    </div>
                                                    <div class="row">
